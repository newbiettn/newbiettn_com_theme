...
<div class="twelve columns">
    <h1 class="archive_title"><span><?php _e("Search Results for:", "aude"); ?> <?php the_search_query(); ?></span></h1>
</div>
</div>
...
<?php
  ...
  ?>  
    ...
    <div class="ten columns">
      ...
      <p class="written"><?php _e('Written by','aude'); ?> <?php the_author_posts_link(); ?><?php if('page' != $post->post_type) { ?>, <?php _e(' Posted in ', 'aude'); the_category(', ') ?><?php } ?></p>
