...
<div class="twelve columns">
    <h1 class="archive_title">
            <?php if (is_category()) { ?>
              <span><?php single_cat_title(); ?><?php _e(" Archive", "aude"); ?></span>
            <?php } elseif (is_tag()) { ?> 
              <span><?php single_tag_title(); ?><?php _e(" Archive", "aude"); ?></span>
...
<?php
  ...
  ?> 
    ...
    <div class="ten columns">
      ...
      <p class="written"><?php _e('Written by','aude'); ?> <?php the_author_posts_link(); ?>, <?php _e(' Posted in ', 'aude'); the_category(', ') ?></p>
